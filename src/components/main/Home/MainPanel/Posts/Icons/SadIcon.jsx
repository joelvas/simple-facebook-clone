  ...
  return (
    ...
    >
      <defs>
        ...
        <linearGradient id="ds" x1="50%" x2="50%" y1="0%" y2="100%">
        ...
        <linearGradient id="hs" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#E78E0D" />
          <stop offset="100%" stopColor="#CB6000" />
        </linearGradient>
        <linearGradient id="is" x1="50%" x2="50%" y1="81.899%" y2="17.94%">
          <stop offset="0%" stopColor="#35CAFC" />
          <stop offset="100%" stopColor="#007EDB" />
        </linearGradient>
        <linearGradient id="js" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#6AE1FF" stopOpacity=".287" />
          <stop offset="100%" stopColor="#A8E3FF" stopOpacity=".799" />
        </linearGradient>
        <filter
          id="c"
          width="118.8%"
      ...
      <g fill="none">
        ...
        />
        <use fill="url(#es)" href="#fs" />
        <use fill="black" filter="url(#gs)" href="#fs" />
        <path
          fill="#4E506A"
