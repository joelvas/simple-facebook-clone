  ...
  return (
    ...
    >
      <defs>
        ...
        <linearGradient id="dw" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#472315" />
          <stop offset="100%" stopColor="#8B3A0E" />
        </linearGradient>
        <linearGradient id="ew" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#191A33" />
          <stop offset="87.162%" stopColor="#3B426A" />
        </linearGradient>
        <linearGradient id="jw" x1="50%" x2="50%" y1="0%" y2="100%">
      ...
      <g fill="none">
        ...
        />
        <use fill="url(#ew)" href="#fw" />
        <use fill="black" filter="url(#gw)" href="#fw" />
        <path
          fill="#4E506A"
        ...
        />
        <use fill="black" filter="url(#hw)" href="#iw" />
        <use fill="url(#jw)" href="#iw" />
      </g>
    </svg>
  )
}
