...
const AngryIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
      <defs>
        <linearGradient id="aa" x1="50%" x2="50%" y1="0%" y2="67.194%">
      ...
      <g fill="none">
        <use fill="url(#aa)" href="#b" />
        <use fill="black" filter="url(#c)" href="#b" />
        <use fill="black" filter="url(#d)" href="#e" />
        ...
        />
        <use fill="black" filter="url(#j)" href="#k" />
        <use fill="url(#l)" href="#k" />
      </g>
    </svg>
  )
}
