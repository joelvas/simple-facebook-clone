    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 180 180">
      ...
      <defs>
        ...
        >
          ...
          <stop stopColor="#F08423" stopOpacity=".34" offset="100%" />{' '}
        </radialGradient>{' '}
        <radialGradient
          cx="50%"
          cy="44.086%"
        ...
        >
          {' '}
          <stop stopColor="#F28A2D" stopOpacity=".5" offset="0%" />{' '}
        ...
        >
          {' '}
          <stop stopColor="#D45F00" stopOpacity=".25" offset="0%" />{' '}
        ...
        <radialGradient
          ...
          fy="12.637%"
          r="12.093%"
          gradientTransform="rotate(11.848 .192 .076) scale(1 .19886)"
          id="hc"
        >
          {' '}
          <stop stopColor="#D45F00" stopOpacity=".25" offset="0%" />{' '}
        ...
        <radialGradient
          ...
          fy="44.274%"
          r="29.002%"
          gradientTransform="scale(.92955 1) rotate(20.36 .764 .598)"
          id="pc"
        >
          {' '}
          <stop stopColor="#FF7091" stopOpacity=".7" offset="0%" />{' '}
        ...
        <radialGradient
          ...
          fy="29.688%"
          r="29.002%"
          gradientTransform="scale(.92955 1) rotate(20.36 .278 .353)"
          id="qc"
        >
          {' '}
          <stop stopColor="#FF7091" stopOpacity=".7" offset="0%" />{' '}
        ...
        >
          {' '}
          <stop stopColor="#9C0600" stopOpacity=".999" offset="0%" />{' '}
          <stop stopColor="#9C0600" stopOpacity=".94" offset="26.692%" />{' '}
        ...
        >
          {' '}
          <stop stopColor="#C71C08" stopOpacity=".75" offset="0%" />{' '}
          <stop stopColor="#C71C08" stopOpacity=".704" offset="53.056%" />{' '}
        ...
        >
          {' '}
          <stop stopColor="#9C0600" stopOpacity=".5" offset="0%" />{' '}
          <stop stopColor="#9C0600" stopOpacity=".473" offset="31.614%" />{' '}
          <stop stopColor="#9C0600" stopOpacity="0" offset="100%" />{' '}
        </radialGradient>{' '}
        <radialGradient
          cx="74.586%"
        ...
        >
          {' '}
          <stop stopColor="#9C0600" stopOpacity=".999" offset="0%" />{' '}
          <stop stopColor="#9C0600" stopOpacity=".934" offset="45.7%" />{' '}
          <stop stopColor="#9C0600" stopOpacity=".803" offset="59.211%" />{' '}
          <stop stopColor="#9C0600" stopOpacity="0" offset="100%" />{' '}
        </radialGradient>{' '}
        <radialGradient
          cx="50.001%"
        ...
        <linearGradient x1="50%" y1="95.035%" x2="50%" y2="7.417%" id="bc">
          {' '}
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <g fillRule="nonzero">
          ...
          <g transform="translate(.005 -.004)">
            {' '}
            <use fill="url(#bc)" href="#ac" />{' '}
            <use fill="url(#cc)" href="#ac" />{' '}
            <use fill="url(#dc)" href="#ac" />{' '}
            <use fill="url(#ec)" href="#ac" />{' '}
            <use fill="url(#fc)" href="#ac" />{' '}
            <use fill="url(#gc)" href="#ac" />{' '}
            <use fill="url(#hc)" href="#ac" />{' '}
          </g>{' '}
          <path
        ...
        <g fillRule="nonzero">
          {' '}
          <use fill="url(#oc)" href="#nc" /> <use fill="url(#pc)" href="#nc" />{' '}
          <use fill="url(#qc)" href="#nc" /> <use fill="url(#rc)" href="#nc" />{' '}
          <use fill="url(#sc)" href="#nc" /> <use fill="url(#tc)" href="#nc" />{' '}
          <use fill="url(#uc)" href="#nc" />{' '}
          <use fillOpacity=".5" fill="url(#vc)" href="#nc" />{' '}
        </g>{' '}
        <g transform="translate(-.637 -.004)">
          {' '}
          <mask id="yc" fill="white">
            {' '}
            <use href="#wc" />{' '}
          </mask>{' '}
          <path
