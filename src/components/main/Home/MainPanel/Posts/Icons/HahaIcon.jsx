...
const HahaIcon = () => {
  return (
    ...
    >
      <defs>
        <linearGradient id="ah" x1="50%" x2="50%" y1="10.25%" y2="100%">
          <stop offset="0%" stopColor="#FEEA70" />
          <stop offset="100%" stopColor="#F69B30" />
        </linearGradient>
        <linearGradient id="dh" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#472315" />
          <stop offset="100%" stopColor="#8B3A0E" />
        </linearGradient>
        <linearGradient id="eh" x1="50%" x2="50%" y1="0%" y2="81.902%">
